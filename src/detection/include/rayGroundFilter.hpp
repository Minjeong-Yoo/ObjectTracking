...
public:
    ...
    bool removeFloor_rayGroundFilter(const sensor_msgs::PointCloud2::ConstPtr& in_sensor_cloud, const sensor_msgs::PointCloud2::ConstPtr& out_sensor_cloud);

private: 
    // Processing function
    bool ConvertAndTrim(const sensor_msgs::PointCloud2::ConstPtr in_cloud_ptr,
    ...
    bool FilteredCloud(const sensor_msgs::PointCloud2ConstPtr in_origin_cloud, const std::vector<void*>& in_selector, sensor_msgs::PointCloud2::ConstPtr out_cloud_msg);
